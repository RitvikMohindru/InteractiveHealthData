...
async function loadData() {
  ...
  gamified_data = await d3.csv("./radar_data/gamified_stats_by_second.csv", (d) => {
  ...
  non_gamified_data = await d3.csv("./radar_data/non_gamified_stats_by_second.csv", (d) => {
    d.time_elapsed = parseFloat(d.time_elapsed);
    d.bvp = parseFloat(d.bvp);
    d.eda = parseFloat(d.eda);
    d.temp = parseFloat(d.temp);
...
svg.selectAll(".non-gamified-path")
...
legend.append("text")
  ...
  input.addEventListener("input", (event) => {
        ...
        const nonGamifiedDataPoint = getDataPointByTimeElapsed(second, non_gamified_data);
